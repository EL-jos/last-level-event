...
<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3   bg-gradient-dark" id="sidenav-main">
    ...
    <div class="collapse navbar-collapse  w-auto " id="sidenav-collapse-main">
        <ul class="navbar-nav">
            {{--<li class="nav-item">
                <a @class(['nav-link text-white', 'active bg-gradient-primary' => str_contains($route, 'admin.home')]) href="{{ route('category.index') }}">
            ...
            <li class="nav-item">
                <a @class(['nav-link text-white', 'active bg-gradient-primary' => str_contains($route, 'type.')]) href="{{ route('type.index') }}">
                    <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
            ...
            <li class="nav-item">
                <a @class(['nav-link text-white', 'active bg-gradient-primary' => str_contains($route, 'organiser.')]) href="{{ route('organiser.index') }}">
                    <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
                        <i class="material-icons opacity-10">receipt_long</i>
                    </div>
                    <span class="nav-link-text ms-1">Organisateurs</span>
                </a>
            </li>
            <li class="nav-item">
                <a @class(['nav-link text-white', 'active bg-gradient-primary' => str_contains($route, 'event.')]) href="{{ route('event.index') }}">
                    <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
                        <i class="material-icons opacity-10">receipt_long</i>
                    </div>
