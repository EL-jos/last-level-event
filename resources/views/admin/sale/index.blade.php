...
@section('main-content')
    ...
    <a class="btn btn-primary" href="{{ route('sale.create') }}" role="button">Ajouter</a>
    <div class="row">
        <div class="col-12">
            <div class="card my-4">
                    ...
                    <div class="table-responsive p-0">
                        <table class="table align-items-center mb-0">
                            ...
                            <tr>
                                ...
                                <th class="text-center text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">Acheteur</th>
                                <th class="text-center text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">Evénement</th>
                                ...
                                @foreach($sales as $sale)
                                    <tr>
                                        <td class="align-middle text-center text-sm">
                                            <h6 class="mb-0 text-sm">{{ $sale->ref }}</h6>
                                        </td>
                                        <td class="align-middle text-center text-sm">
                                            <div class="d-flex gap-1 flex-column">
                                                <span class="text-secondary text-xs font-weight-bold">{{ $sale->user->username }}</span>

                                                    <div class="d-flex gap-1">
                                                        <p class="text-xs text-secondary mb-0 text-success">{{ $sale->user->name }}</p>
                                                        <p class="text-xs text-secondary mb-0 text-success">{{ $sale->user->lastname }}</p>
                                                    </div>
                                            </div>
                                        </td>
                                        <td class="align-middle text-center text-sm">
                                            <span class="text-secondary text-xs font-weight-bold">{{ $sale->event->title }}</span>
                                        </td>
                                        <td class="align-middle text-center text-sm">
                                            <span class="text-secondary text-xs font-weight-bold">{{ $sale->quantity }}</span>
                                        </td>
                                        <td class="align-middle text-center text-sm">
                                            <span class="text-secondary text-xs font-weight-bold">{{ $sale->type->name }}</span>
                                        </td>
                                        <td class="align-middle text-center text-sm">
