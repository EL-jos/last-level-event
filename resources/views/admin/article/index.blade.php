            ...
            <div class="card my-4">
                <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
                    <div class="bg-gradient-primary shadow-primary border-radius-lg pt-4 pb-3">
                        <h6 class="text-white text-capitalize ps-3">List de toutes les articles</h6>
                    </div>
                </div>
                                    ...
                                    <tr>
                                        <td>
                                            <div class="d-flex px-2 py-1">
                                                <div>
                                                    <img src="{{ asset($article->images()->first()->url) }}" class="avatar avatar-sm me-3 border-radius-lg" alt="user1">
                                                </div>
                                        ...
                                        <td class="align-middle text-center text-sm">
                                            <span class="badge badge-sm bg-gradient-success">{{ $article->delete_at == null ? 'OnLine' : 'OnffLine' }}</span>
                                        </td>
