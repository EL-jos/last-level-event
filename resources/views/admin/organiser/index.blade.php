...
@section('main-content')
    ...
    <a class="btn btn-primary" href="{{ route('organiser.create') }}" role="button">Ajouter</a>
    <div class="row">
        <div class="col-12">
            <div class="card my-4">
                <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
                    <div class="bg-gradient-primary shadow-primary border-radius-lg pt-4 pb-3">
                        <h6 class="text-white text-capitalize ps-3">List de toutes les organisateurs</h6>
                    </div>
                </div>
                    ...
                    <div class="table-responsive p-0">
                        <table class="table align-items-center mb-0">
                            ...
                            @foreach($organisers as $organiser)
                                <tr>
                                    <td>
                                        <h6 class="mb-0 text-sm">{{ $organiser->name }}</h6>
                                    </td>
                                    <td>
                                        <h6 class="mb-0 text-sm">{{ $organiser->email }}</h6>
                                    </td>
                                    <td>
                                        <h6 class="mb-0 text-sm">{{ $organiser->phone }}</h6>
                                    </td>
                                    <td>
                                        <h6 class="mb-0 text-sm">{{ $organiser->address }}</h6>
                                    </td>
                                    <td class="align-middle text-center text-sm">
                                        <span class="badge badge-sm bg-gradient-success">{{ $organiser->delete_at == null ? 'OnLine' : 'OnffLine' }}</span>
                                    </td>
                                    <td class="align-middle text-center">
                                        <span class="text-secondary text-xs font-weight-bold">{{ date('d/m/Y à H:m:s', strtotime($organiser->updated_at)) }}</span>
                                    </td>
                                    <td class="align-middle">
                                        <div class="d-flex gap-2 w-100 justify-content-end">
                                            <a href="{{route('organiser.edit', $organiser)}}" class="btn btn-primary" data-toggle="tooltip" data-original-title="Edit user">
                                                Editer
                                            </a>
                                            <form action="{{ route('organiser.destroy', $organiser) }}" method="post">
                                                @csrf
                                                @method('delete')
